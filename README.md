...
- Mac/Xcode and a physical iOS device for Sign in with Apple, StoreKit, signed entitlement, and native build verification.
- PostgreSQL for API work once the database phase begins.

Expo Go is not a complete supported runtime because Fortuneness uses a local Swift module for StoreKit 2.
